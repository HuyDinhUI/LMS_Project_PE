  ...
  return (
    <div className="py-5 px-5 w-full h-full dark:bg-card overflow-auto">
      <div className="w-full px-2">
        <h2 className="text-2xl uppercase">Courses</h2>
      </div>
      <div className="mt-5">
        <div></div>
        <div className="grid grid-cols-3 gap-3">
          {classData.map((c) => (
            <Link
              ...
              key={c.MaLop}
              className="rounded-md overflow-hidden hover:-translate-y-1 transition-transform"
            >
              <div className="h-30 w-full flex items-end bg-[url('https://img.freepik.com/free-vector/hand-drawn-minimal-background_23-2149008068.jpg?uid=R40278496&ga=GA1.1.12754122.1753975824&semt=ais_hybrid&w=740&q=80')] bg-cover">
                <div className="p-3">
